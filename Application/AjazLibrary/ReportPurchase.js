...
function ShowRport(repotType) {
    ...
    $.ajax
        ({
            ...
            url: "rptPurchase.aspx/ShowRport", //page/method name
...
function LoadReport(dtReport) {
    ...
    for (var i = 0, len = dtReport.length; i < len; i++) {
        ...
        else if (repotType == 2 || repotType == 3 || repotType == 4) {
    ...
    if (repotType == 1) {
        ...
        $('#lblHeaderSales').text('Date Wise Purchase Report');
        ...
        $('#lblQtySaleSummary').text(qty);
        $('#lblAmountSaleSummary').text(totalamount);
        $('#lblHeaderSales').text('Item Wise Purchase Report');
        $('#tblSalesSummary').show();
    }
    else if (repotType == 3) {
        ...
        $('#lblQtySaleSummary').text(qty);
        $('#lblAmountSaleSummary').text(totalamount);
        $('#lblHeaderSales').text('Category Wise Purchase Report');
        $('#tblSalesSummary').show();
    }
    else if (repotType == 4) {
        $('#lblColumnName').text('Supplier Name');
        $('#lblQtySaleSummary').text(qty);
        $('#lblAmountSaleSummary').text(totalamount);
        $('#lblHeaderSales').text('Supplier Wise Purchase Report');
        $('#tblSalesSummary').show();
    }
    $.print("#dvSales");
}
