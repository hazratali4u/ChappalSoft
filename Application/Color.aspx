<%@ Page Title="ChappalSoft : Add Color" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Color.aspx.cs" Inherits="Color" %>
                    ...
                    <div class="row" runat="server" id="divView">
                        <div class="card" style="width: 100%;">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search Color" onkeyup="filterGridView()"></asp:TextBox>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gvColor" runat="server" CssClass="table table-striped" AutoGenerateColumns="False"
                                        OnRowEditing="gvColor_RowEditing" OnRowDeleting="gvColor_RowDeleting" OnRowDataBound="gvColor_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Name" HeaderText="Color Name" ItemStyle-Width="40%" ReadOnly="true" />
                                            <asp:BoundField DataField="Status" ReadOnly="true">
                                                <HeaderStyle CssClass="HidePanel" />
                                                <ItemStyle CssClass="HidePanel" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ColorCode" ReadOnly="true">
                                                <HeaderStyle CssClass="HidePanel" />
                                                <ItemStyle CssClass="HidePanel" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ShowName" ReadOnly="true">
                                                <HeaderStyle CssClass="HidePanel" />
                                                <ItemStyle CssClass="HidePanel" />
                                            </asp:BoundField>
                    ...
                    <div class="row" runat="server" id="divAdd" visible="false">
                        <div class="card" style="width: 100%;">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="lblColorName">Color Name *</label>
                                    <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="Color Name" onkeyup="NameKeyUp()"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="lblColor">Select Color</label>
                                    <input type="color" id="colorPicker" runat="server" />
                                        </div>
                                        <div class="col-md-4">
                                            <asp:CheckBox ID="cbShowName" runat="server" Text="Show Name" />
                                        </div>
                                    </div>
                                    
                                </div>
                                <asp:Button ID="btnSave" runat="server" class="btn btn-primary mr-2" Text="Save" OnClientClick="return Color();" OnClick="btnSave_Click" />
