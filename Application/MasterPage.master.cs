    ...
    private void LoadJSFile()
    {
        ...
        switch(url)
        {
            ...
            case "Party.aspx":
                ...
                break;
            case "Expense.aspx":
                ltrlFiles.Text = "<script src='AjazLibrary/Expense.js'></script>";
                break;
            case "ExpenseHead.aspx":
                ltrlFiles.Text = "<script src='AjazLibrary/ExpenseHead.js'></script>";
                break;
            case "rptItem.aspx":
            ...
            case "rptProfitLoss.aspx":
                ...
                break;
            case "Home.aspx":
                ltrlFiles.Text = "<script src='assets/js/dashboard.js'></script>";
                break;
        }        
    }   
}