<%@ Page Title="ChappalSoft : POS Bar Code" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SaleBarCode.aspx.cs" Inherits="SaleBarCode" %>
                    ...
                    <div class="page-header flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">POS Bar Code</li>
                            </ol>
                        </nav>
                        ...
                        <div class="col-md-5" style="padding-right: 5px; padding-left: 5px;">
                            <div class="card" style="width: 100%;">
                                ...
                                <div class="card-body" style="width: 100%; padding: 0px;">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Enter Bar Code" ToolTip="Enter Bar Code" onkeypress="txtSearchKeyPress(event);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
