<%@ Page Title="ChappalSoft : Stock Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rptCustomer.aspx.cs" Inherits="rptCustomer" %>
...
<asp:Content ID="pageContent" ContentPlaceHolderID="childPage" runat="Server">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" Width="50%">
                                        ...
                                        <asp:ListItem Value="2" Text="Customer Balance"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div class="form-group" id="dvCustomer">
                                    ...
                                    <asp:HiddenField ID="hfOpeningBalance" runat="server" Value="0" />
                                </div>                                
                                <div class="form-group" id="dvFromDate">
                                ...
                                <button type="button" id="btnView" class="btn btn-primary mr-2" onclick="ShowLedgerRport();"> View Report </button>
    ...
    <% Response.WriteFile("~/Reports/rptCustomerLedger.htm");%>
</asp:Content>