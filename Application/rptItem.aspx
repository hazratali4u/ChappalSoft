<%@ Page Title="ChappalSoft : Stock Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rptItem.aspx.cs" Inherits="rptItem" %>
...
<asp:Content ID="pageContent" ContentPlaceHolderID="childPage" runat="Server">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" Width="50%">
                                        <asp:ListItem Value="1" Text="Stock Summary" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Stock Detail"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Item Wise Profit"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="button" id="btnView" class="btn btn-primary mr-2" onclick="ViewStockReport();"> View Report </button>
    ...
    <% Response.WriteFile("~/Reports/rptStockSummary.htm");%>
</asp:Content>