...
public partial class rptItem : System.Web.UI.Page
{
    ...
    [WebMethod]
    [ScriptMethod]
    public static string ShowSummaryRport(string CategoryID,string ItemID,string FromDate, string ToDate,int ReportType)
    {
        ReportController report = new ReportController();
        DataTable dtReport = report.GetStockReport(Convert.ToInt32(CategoryID), Convert.ToInt32(ItemID), Convert.ToDateTime(FromDate), Convert.ToDateTime(ToDate), ReportType);
