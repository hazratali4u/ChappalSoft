<%@ Page Title="ChappalSoft : Stock Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rptPurchase.aspx.cs" Inherits="rptPurchase" %>
                    ...
                    <div class="page-header flex-wrap">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Purcahse Report </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" Width="50%">
                                        ...
                                        <asp:ListItem Value="4" Text="Supplier Wise"></asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
