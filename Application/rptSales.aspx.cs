...
public partial class rptSales : System.Web.UI.Page
{
    ...
    public static string ShowRport(string CategoryID,string ItemID,string FromDate, string ToDate,int ReportType)
    {
        ...
        DataTable dtReport = report.GetSalesReport(Convert.ToInt32(CategoryID), Convert.ToInt32(ItemID), Convert.ToDateTime(FromDate), Convert.ToDateTime(ToDate), ReportType);
